...
class PVOutputClient():
    ...
    def add_output(self, date, generated, exported=None, peak_power=None, peak_time=None, condition=None,
                   min_temperature=None, max_temperature=None, comments=None, import_peak=None, import_offpeak=None,
    ...
    def add_status(self, date, time, energy_generation=None, power_generation=None, energy_consumption=None,
                   power_consumption=None, temperature=None, voltage=None, cumulative=False):
        """
    ...
    def get_status(self, date=None, time=None):
        ...
        rsp = response.read().decode("utf-8").split(",")
