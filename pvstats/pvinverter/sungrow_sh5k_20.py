...
_register_map = {
    'input': {
        ...
        5035: {'name': 'mystery_5035', 'scale': Decimal(1), 'units': 'W', 'type': 'int16'},
        # -1000 to 1000. Possibly needs a 0.1 scale?
        ...
        # 0-15. Four-bit state? Possibly?
        13037: {'name': 'mystery_13037', 'scale': Decimal(1), 'units': 'W', 'type': 'uint16'},
        # Accumulates. Possibly total kWh consumed?
